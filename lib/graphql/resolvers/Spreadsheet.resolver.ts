...
export default class SpreadsheetResolver { 
    ...
    async getSpreadsheetOverviewRevenueData() {
        ...
        if (endIndex === -1 ) {
            console.log("Cannot find end index of revenue section in Overview sheet- looking for cell 'Sub Category' " );
            return []
        }
    ...
    async getSpreadsheetOverviewDivisionsData() {
        ...
        // Sanity check in case google sheet column is no longer called "Sub category"
        if (startIndex === -1 ) {
            console.log("Cannot find start index of division section in Overview sheet - looking for cell 'Sub Category' " );
            return [];
        }   
        ...
        if (endIndex === -1 ) { 
            console.log("Cannot find start index of division section in Overview sheet - looking for cell 'Events' " );
            return [];
        }
