        ...
        <ApplicationCard
          ...
          buttons={[
            <PopupButton
              ...
              className="my-button"
            >
              <div className="text-center cursor-pointer transition-all duration-75 w-fit bg-gradient-to-r from-pink-700 to-purple-700 hover:opacity-80 text-white font-Gilroy font-bold py-2 px-8">apply</div>
            </PopupButton>,
