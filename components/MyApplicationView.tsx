...
export default function MyApplicationView({ appData } : MyApplicationViewProps) {
    return <div className="w-full flex flex-wrap gap-[30px]">
        ...
        <div className="flex flex-col items-end w-fit">
            <div className="w-80 p-6 rounded-3xl space-y-2 flex flex-col justify-between bg-gray-200/5 outline outline-gray-100/10">
                <div className="w-full flex justify-between items-center gap-[20px]">
                    ...
                    { status === "accepted" ? 
                        ...
                        >
                            ...
                            />
                        </svg> : <h4 className="text-white">{status}</h4>
